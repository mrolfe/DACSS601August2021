...
\hypersetup{
  pdftitle={Sample Tidy},
  pdfauthor={Todd Jennings},
  hidelinks,
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{poultry }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\AttributeTok{file =} \StringTok{"poultry\_tidy.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
